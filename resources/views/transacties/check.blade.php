...
@section('content')
    ...
    <form class="card" method="POST" action="/transacties/process">
        ...
        <div class="form-row">
            ...
            <div class="col-md">
                ...
                <select class="form-control mb-3" id="af_bij" name="af_bij" required>
                    <option disabled value="">Selecteer af/bij</option>
                    <option @if($transactie[5] == "Af") selected @endif value="Af">Af</option>
                    <option @if($transactie[5] == "Bij") selected @endif value="Bij">Bij</option>
                </select>
            </div>
            <div class="col-md">
        ...
        <input type="text" class="form-control mb-3" id="mededelingen" name="mededelingen" value="{{ $transactie[8] }}" required>
        <hr>
        @endforeach
