...
<table class="table table-hover table-sm table-responsive ">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-link" href="/uitgaven/{{$koste->uitgave_id_boete}}/wijzig/{{$koste->jaargang}}"><span
            ...
            <td>
                <a class="btn btn-link" href="/uitgaven/{{$koste->uitgave_id_extra}}/wijzig/{{$koste->jaargang}}"><span
                        data-feather="edit"></span>
            ...
            @else
            <td>
                <a class="btn btn-link" href="/kosten/{{$koste->kosten_id}}/wijzig/{{$koste->jaargang}}"><span data-feather="edit"></span>
                    Wijzig</a>
            </td>
            <td>
