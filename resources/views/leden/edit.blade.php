...
<div class="card">
    <form class="card-body" method="POST" action="/leden/{{$lid->lid_id}}">
        @csrf
        @method('patch')
        ...
        <input type="number" class="form-control mb-3" id="verschuldigd" name="verschuldigd" step=".01" required
            value="{{$lid->verschuldigd}}">
        <label for="overgemaakt">Overgemaakt</label>
        <input type="number" class="form-control mb-3" id="overgemaakt" name="overgemaakt" step=".01" required
            value="{{$lid->overgemaakt}}">
        <label for="gespaard">Gespaard</label>
        <input type="number" class="form-control mb-3" id="gespaard" name="gespaard" step=".01" required
            value="{{$lid->gespaard}}">
