...
<div class="card">
    <form class="card-body" method="POST" action="/uitgaven/{{$uitgave->uitgave_id}}">
        @csrf
        @method('PATCH')
        <h3>Activiteit</h3>
        <div class="form-row">
            <div class="col-md-3">
                ...
                <input type="date" class="form-control mb-3" id="datum" name="datum" value="{{ $uitgave->datum }}"
                    required>
            </div>
            <div class="col-md-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" id="budget" name="budget" step=".01"
                        value="{{ $uitgave->budget }}" min="0" max="99999999" placeholder="Vul bedrag in" required>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control " id="uitgave" name="uitgave" step=".01"
                        value="{{ $uitgave->uitgave }}" min="-99999999" max="99999999" placeholder="Vul bedrag in" required>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" id="naheffing" name="naheffing" step=".01"
                        value="{{ $uitgave->naheffing }}" max="99999999" placeholder="0.00" required readonly>
                </div>
            </div>
        </div>
